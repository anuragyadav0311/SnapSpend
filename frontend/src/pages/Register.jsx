...
export default function Register() {
  ...
  const handleSocialSignup = async (provider) => {
    ...
    try {
      ...
      setSubmitError(error.message || `Unable to continue with ${provider === "apple" ? "Apple" : "Google"} right now.`);
      setSubmitting(false);
    }
  };
          ...
          <div className={panelClassName(0)}>
            ...
            <div className="social-row">
              ...
              >
                ...
                {submitting ? "Connecting..." : "Apple"}
              </button>
            </div>

            {submitError && <div className="err-text">{submitError}</div>}
